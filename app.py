...
def streamlit_menu():
    with st.sidebar:
        selected = option_menu(
            ...
            options=["Profile", "Skin Care", "Get Recommendation", "Skin Care 101"],
...
def Skin_care():
    ...
    st.write(
        """
        ##### **Welcome to the Skin Care Recommender System! We're here to help you find the perfect skincare products to your skin type and concerns. Rest assured, your skincare journey is in good hands with our personalized recommendations!**
        """)
